...
NumOfDigits. Занятия по PHP. Простой Ввод/вывод. Алгоритмы. Консольное приложение.
Проект консольного приложения написан на языке программирования PHP и реализован в интегрированной среде Apache NetBeans (в редакторе Microsoft Visual Studio Code).  
Простой ввод-вывод. Определение количества цифр в числе, введённом с клавиатуры.
